...
/**
 * A ContractError is thrown when the API response message for a given resource does not adhere to the current service contract requirements as specified in the documentation.<p/>
 *
